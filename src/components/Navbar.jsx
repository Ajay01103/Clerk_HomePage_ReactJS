    ...
    <React.Fragment>
      ...
      >
        <MenuHandler>
          ...
          >
            <ListItem
              className="flex items-center gap-2 py-2 pr-4 font-medium text-gray-900 transition-all duration-75"
...
export function NavbarWithMegaMenu() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 sticky top-2 z-10 h-max bg-opacity-70">
      <div className="flex items-center justify-between text-blue-gray-900">
        ...
        <div className="hidden lg:block">
          <NavList className="transition-all duration-100" />
        </div>
